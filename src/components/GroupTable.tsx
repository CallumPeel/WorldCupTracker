              ...
              return (
                ...
                >
                  <td className="py-3 pr-2">
                    <span className={`font-semibold ${isQualified ? 'text-primary' : ''}`}>
                      {index + 1}
                    </span>
                  </td>
                  <td className="py-3 px-2">
                    <div className="flex items-center gap-2">
                      <span className="text-2xl">{standing.team.flag}</span>
                      <div>
                        <div className="font-semibold">{standing.team.name}</div>
                        <div className="text-xs text-gray-500">{standing.team.code}</div>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="text-center py-3 px-1 tabular-nums">
                    <span className={standing.goalDifference > 0 ? 'text-green-500' : standing.goalDifference < 0 ? 'text-red-500' : ''}>
